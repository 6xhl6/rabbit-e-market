  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-132 sk-text">7.90</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-527 sk-text"
            >灰尘毛发静电吸附地板除尘干巾40片/包</view
          >
          <view class="desc sk-transparent sk-text-0-0000-514 sk-text">干湿两用，静电除尘app</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-606 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-141 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-705 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-81 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-629 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-35 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
